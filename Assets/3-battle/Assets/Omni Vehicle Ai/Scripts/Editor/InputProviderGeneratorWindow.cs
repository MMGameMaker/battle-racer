...
public class InputProviderGeneratorWindow : EditorWindow
{
    ...
    [MenuItem("Tools/Assets/Omni Vehicle Ai/Input Provider Generator")]
    ...
    private void CreateScript()
    {
        ...
        string path = EditorUtility.SaveFilePanelInProject("Save Input Provider Script", scriptName, "cs", "Please enter a file name to save the script.", "Assets/Assets/Omni Vehicle Ai");
